...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Show origin
        sceneView.debugOptions = [ARSCNDebugOptions.showWorldOrigin, ARSCNDebugOptions.showCameras, ARSCNDebugOptions.showFeaturePoints]
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // Enable horizonthal plane detection
